...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaG9zc2VpbnJhaG1hdGkiLCJhIjoiY20wNThmbTloMGhkNzJycjBpYnFnYTh6aiJ9.oGpNCPXlNMsbNXI4dQamaA';
...
const VERSION = exports.VERSION = "1.7.5";
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Welcome!');
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error logginh out! Try again.');
        case 11:
        case "end":
...
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "35993" + '/');
